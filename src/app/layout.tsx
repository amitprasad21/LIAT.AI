  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning={true}>
      <body
        ...
        className={`${playfair.variable} ${inter.variable} ${cormorant.variable} bg-gradient-to-br from-[#E0E9F5] via-[#E4EBF5] to-[#F1F6FA] text-text-primary font-sans antialiased min-h-screen selection:bg-gold selection:text-white`}
      >
        <a
          href="#main-content"
